...
export default function Footer() {
  return (
    <div className=" border-t-2 p-4 flex flex-col items-center text-lg bg-[alt] md:flex md:flex-row md:justify-between ">
        <div>
            Designed and Developed by Deepak Mehra
        </div>

        <div>Copyright &#169; Deepak Mehra</div>

        <div><div className="flex mt-5 gap-4 mb-3 md:mr-6">
            <div className="h-[16px] w-[19px] hover:bg-gray-500 hover:rounded-lg hover:scale-125">
